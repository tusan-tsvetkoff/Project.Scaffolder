...
public sealed partial class IconMappingService
{
    ...
    {
        internal static readonly Dictionary<string, string> ConfigMappings =
            new()
            {
                { ".json", "\ue60b" },
                { ".xml", "\ue619" },
        ...
        internal static readonly Dictionary<string, string> DotNetMappings =
            new()
            {
                { ".cs", "\udb80\udf1b" },
                { ".csproj", "\ue70c" },
        ...
        internal static readonly Dictionary<string, string> DirectoryMappings =
            new()
            {
